# This example Dockerfile creates a self-contained Python Flask web application container.
# It installs Flask, creates a simple web server, and exposes port 5000 to allow access.
